package com.caiths.oculichatback.aop;
 ...
 * <p>适用范围：</p>
 * <ul>
 *     <li>拦截所有位于 `com.caiths.oculichatback.controller` 包中的方法。</li>
 * </ul>
 *
 * 使用示例：
 * <pre>{@code
...
public class LogInterceptor {
     ...
     * 环绕通知，用于记录请求和响应日志。
     * <p>
     * 拦截 `com.caiths.oculichatback.controller` 包下的所有方法，记录请求的唯一 ID、路径、IP 地址、参数，以及执行时间。
     * </p>
     *
     ...
     */
    @Around("execution(* com.caiths.oculichatback.controller.*.*(..))")
