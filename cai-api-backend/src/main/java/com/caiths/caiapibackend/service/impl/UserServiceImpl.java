...
import com.caiths.caiapibackend.mapper.UserMapper;
import com.caiths.caiapibackend.model.dto.user.*;
import com.caiths.caiapibackend.model.entity.User;
import com.caiths.caiapibackend.model.enums.UserAccountStatusEnum;
...
import static com.caiths.caiapibackend.constant.EmailConstant.CAPTCHA_CACHE_KEY;
import static com.caiths.caiapibackend.constant.UserConstant.*;


/**
 * UserServiceImpl 是用户服务的实现类。
 * <p>
 * 该类负责处理用户注册、登录、邮箱绑定等相关的业务逻辑，
 * 并管理用户信息的验证与更新。
 * </p>
 *
 * @author poboll
