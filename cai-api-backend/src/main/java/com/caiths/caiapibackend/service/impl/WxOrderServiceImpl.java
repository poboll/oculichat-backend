...
import static com.caiths.caiapibackend.constant.PayConstant.ORDER_PREFIX;
import static com.caiths.caiapibackend.constant.PayConstant.QUERY_ORDER_STATUS;
import static com.caiths.caiapibackend.model.enums.PayTypeStatusEnum.WX;
import static com.caiths.caiapibackend.model.enums.PaymentStatusEnum.*;
import static com.caiths.caiapibackend.utils.WxPayUtil.getRequestHeader;

/**
 * 微信订单服务实现类，处理微信支付相关的逻辑。
 *
 * @author poboll
 * @date 2024-12-02
 * @version 1.0
...
public class WxOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder> implements ProductOrderService {
     ...
     * @param payType   支付类型
     * @return 返回产品订单信息 {@link ProductOrderVo}，若不存在返回null
     */
    @Override
