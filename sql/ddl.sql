-- 创建库
create database if not exists cai_api;

-- 切换库
use cai_api;

-- 用户表
create table if not exists cai_api.user
(
...
-- 每日签到表
create table if not exists cai_api.daily_check_in
(
    id          bigint auto_increment comment 'id' primary key,
...
-- 接口信息
create table if not exists cai_api.interface_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 产品信息
create table if not exists cai_api.product_info
(
    id             bigint auto_increment comment 'id' primary key,
...
# 产品订单
create table if not exists cai_api.product_order
(
    id             bigint auto_increment comment 'id' primary key,
...
#付款信息
create table if not exists cai_api.payment_info
(
    id             bigint auto_increment comment 'id' primary key,
...
-- 用户接口调用表
create table if not exists cai_api.user_interface_invoke
(
    id           bigint auto_increment comment 'id' primary key,
...
-- 充值活动表
create table if not exists cai_api.recharge_activity
(
    id         bigint auto_increment comment 'id' primary key,
...
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695338876708544514, '100坤币', '增加100坤币到钱包', 1691069533871013889, 1, 100, 'RECHARGEACTIVITY', 1, null, '2023-08-26 15:34:20', '2023-08-28 12:58:30', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695773972037839073, '9999坤币', '增加9999坤币到钱包', 1691069533871013889, 699, 9999, 'RECHARGE', 1, '2023-08-28 13:01:34', '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695776766919888897, '1000坤币', '增加1000坤币到钱包', 1691069533871013889, 99, 1000, 'RECHARGE', 1, null, '2023-08-27 20:34:21', '2023-08-27 20:34:21', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777072030339073, '3000坤币', '增加3000坤币到钱包', 1691069533871013889, 199, 3000, 'RECHARGE', 1, null, '2023-08-27 20:35:34', '2023-08-27 20:41:29', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695777203236556802, '15999坤币', '增加15999坤币到钱包', 1691069533871013889, 888, 15999, 'RECHARGE', 1, null, '2023-08-27 20:36:05', '2023-08-28 13:02:25', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1695778320091631617, '18999坤币', '增加18999坤币到钱包', 1691069533871013889, 999, 18999, 'RECHARGE', 1, null, '2023-08-27 20:40:32', '2023-08-28 13:02:42', 0);
INSERT INTO cai_api.product_info (id, name, description, userId, total, addPoints, productType, status, expirationTime, createTime, updateTime, isDelete) VALUES (1697087470134259713, '10坤币', '签到获取', 1692848556158709762, 0, 10, 'RECHARGE', 0, null, '2023-08-31 11:22:37', '2023-08-31 11:22:37', 1);

insert into cai_api.interface_info(`id`, `name`, `url`, `userId`, `method`, `requestParams`, `reduceScore`, `requestExample`,
...
values (1705234447153963010, '随机毒鸡汤', 'http://localhost:8090/api/poisonousChickenSoup', 1698354419367571457, 'GET',
        NULL, 1, 'http://localhost:8090/api/poisonousChickenSoup', NULL, NULL, '随机毒鸡汤', 1, 0,
        'https://image.dooo.ng/c/2024/12/17/67610a6053e15.webp', 'JSON',
        ...
        '2024-09-22 22:55:48', '2024-12-17 11:52:06', 0),
       (1705237104270712833, '获取输入的名称', 'http://localhost:8090/api/name', 1698354419367571457, 'GET',
        ...
        'https://image.dooo.ng/c/2024/12/17/67610a604f2fb.webp', 'JSON',
        ...
        '2024-09-22 23:06:22', '2024-12-17 11:52:06', 0),
       (1705237990061580289, '获取随机壁纸', 'http://localhost:8090/api/randomWallpaper', 1698354419367571457, 'GET',
        ...
        'https://image.dooo.ng/c/2024/12/17/67610a6050d97.webp', 'JSON',
        ...
        '2024-09-22 23:09:53', '2024-12-17 11:52:06', 0),
       (1705238841173942274, '获取每日星座运势', 'http://localhost:8090/api/horoscope', 1698354419367571457, 'GET',
        ...
        '2024-09-22 23:13:16', '2024-12-17 11:52:06', 0),
       (1705239469589733378, '随机土味情话', 'http://localhost:8090/api/loveTalk', 1698354419367571457, 'GET', NULL, 1,
        ...
        'https://image.dooo.ng/c/2024/12/17/67610a603d4df.webp', 'JSON',
        ...
        '2024-09-22 23:15:46', '2024-12-17 11:52:06', 0),
       (1705239928861827073, 'IP信息归属地', 'http://localhost:8090/api/ipInfo', 1698354419367571457, 'GET',
        ...
        'https://image.dooo.ng/c/2024/12/17/67610a618d651.webp', 'JSON',
        ...
        '2024-09-22 23:17:35', '2024-12-17 12:18:29', 0),
       (1705240565347459073, '获取天气信息', 'http://localhost:8090/api/weather', 1698354419367571457, 'GET',
        ...
        'https://image.dooo.ng/c/2024/12/17/67610a6011029.webp', 'JSON',
        ...
        '2024-09-22 23:20:07', '2024-12-17 11:52:06', 0);